...
pub enum Command {
    Connect,
    Disconnect,
    WriteSingleCoil((SlaveId, u16, bool, bool)),
    WriteMultipleCoils((SlaveId, u16, Vec<bool>, bool)),
    WriteSingleRegister((SlaveId, u16, u16, bool)),
    WriteMultipleRegisters((SlaveId, u16, Vec<u16>, bool)),
}
