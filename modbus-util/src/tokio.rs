...
///
/// A task spawned by `modbus_util::tokio::spawn_detach()` or `modbus_util::tokio::spawn()` will be part of
/// the global context. These tasks can be joined using `modbus_util::tokio::join_all()`.
#[allow(dead_code)]
...
///
/// ```rust
/// use modbus_util::tokio::spawn_detach;
///
/// #[tokio::main]
/// async fn main() {
...
///
/// ```rust
/// use modbus_util::tokio::spawn_detach_with_context;
///
/// #[tokio::main]
/// async fn main() {
///     // Start the given future as tokio task detached
...
///
/// ```rust
/// use modbus_util::tokio::{spawn_detach, spawn_detach_with_context, join_all};
///
/// #[tokio::main]
/// async fn main() {
///     // Start the given future as tokio task detached
...
///
/// ```rust
/// use modbus_util::tokio::{spawn_detach, spawn_detach_with_context, join_all_of_context};
///
/// #[tokio::main]
/// async fn main() {
///     // Start the given future as tokio task detached
